...
# =============================================================================    
    ...
    def save_data_to_csv(self):
        ...
        black_box_filename = f"flight_data/state_history_yaw90_{self.model_name}_{self.timestr}.xlsx"
        ...
        action_history_filename = f"flight_data/action_history_yaw90_{self.model_name}_{self.timestr}.xlsx"
        mode = 'w' if self.ep == 0 else 'a'
